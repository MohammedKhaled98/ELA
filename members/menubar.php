<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href=<?php echo $myappointment ; ?>><i class="material-icons">group</i> <span>مواعيدي</span></a></li>
       <li><a href=<?php echo $profile ; ?>><i class="material-icons">group</i> <span>ادارة الملف الشخصي</span></a></li>
        <li><a href=<?php echo $book ; ?> ><i class="material-icons">group</i> <span>حجز موعد مع مستشار</span></a></li>
