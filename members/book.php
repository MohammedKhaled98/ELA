...
$y="bookPage.php?id=".$row['id']."&idm=".$idm;




$ed= "https://kkandil.com/adm/costE.php?id=";
			$ed.=$row['id'];
			$del= "https://kkandil.com/adm/costDEL.php?id=";
			$del.=$row['id'];
                      ...
                      echo "
                        <tr>
                          <td class='hidden'></td>
                                     <td> <a href='".$y."' data-toggle='modal' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-user-o'></i> ".$row['Name']."</a></td>

                          <td>".$row['major']."</td>
                          <td>".$row['bio']."</td>
                          
                            <td> <a href='".$ed."' data-toggle='modal' class='btn btn-primary btn-sm btn-flat' style='background-color: #283747 ; border-color: #283747 ;'><i class='fa fa-pencil'></i> الصفحة الشخصية للمزيد من التفاصيل</a>
