...
$day = date('l',strtotime($date.'+0 day'));
...
break; 
 ...
 $sql = mysqli_query($con,"SELECT * FROM `members` WHERE id='$idm' ");
          ...
          $price= "&nbsp&nbsp<s style='font-size: 25px; color:#A93226 ;'> 50 ريال </s> <strong style='font-size: 25px; color:#27AE60'>&nbsp&nbsp 25 ريال </strong>   ";
          }
          else{
             $price= " <strong style='font-size: 25px; '>&nbsp&nbsp 50 ريال </strong>   ";
          }
          }
 $sql = mysqli_query($con,"SELECT * FROM `consultant` WHERE id='$idc' ");
          while($row = mysqli_fetch_array($sql)){
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
          <p style="font-weight: normal; text-align: center;" > <strong style="font-size: 40px;"> تفاصيل الجلسة</strong></p> 
          <p style="font-weight: normal; " > 
         <div style="font-size: 25px;"> اسم المستفيد :  <strong style="font-size: 25px;">&nbsp&nbsp<?php echo $Namem ?> </strong> </div> 
          <div style="font-size: 25px;"> اسم المستشار: <strong style="font-size: 25px;">&nbsp&nbsp<?php echo $Namec ?> </strong> </div> 
          <div  style="font-size: 25px;"> اليوم : <strong style="font-size: 25px;">&nbsp&nbsp<?php echo $weekday?> </strong>  </div > 
          <div  style="font-size: 25px;"> التاريخ : <strong style="font-size: 25px;">&nbsp&nbsp<?php echo $date?> </strong> </div > 
          <div  style="font-size: 25px;"> الوقت :<strong style="font-size: 25px;">&nbsp&nbsp<?php echo $time?> </strong> </div > 
          
        
         <div  style="font-size: 25px;"> سعر الجلسة: <?php echo $price ;?>  <br>
         
        <div style="font-weight: normal; text-align: center;"> <a style = "background:#229954  ;  border-color:#229954  "href="'.$y.'" data-toggle="modal" class="btn btn-primary btn-sm btn-flat" ><i class="fa fa-shopping-cart" aria-hidden="true"></i>  تاكيد والدفع</a> <a style = "background:#C0392B ;  border-color:#C0392B " href="'.$y.'" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-times" aria-hidden="true"></i> العودة</a></div>
