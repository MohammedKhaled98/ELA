		...
		<div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
          		  ...
          		  <div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="user" style="width: 50% ; " value=<?php echo $user?> >
                  	</div>
                  	<label for="sgl" class="col-sm-3 control-label">اسم الدخول :</label>
                 ...
                 <div class="form-group">
          		  ...
          		  <div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="pass" style="width: 50% ; " value="<?php echo $pass?>" >
                  	</div>
                  	<label for="sgl" class="col-sm-3 control-label">كلمة المرور :</label>
                 ...
                 <div class="form-group">
          		  ...
          		  <div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="Zoom_Email" style="width: 50% ; " value=<?php echo $Zoom_Email?> >
                  	</div>
                  	<label for="sgl" class="col-sm-3 control-label">Zoom Email :</label>
                 ...
                 <div class="form-group">
          		  ...
          		  <div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="Zoom_Pass" style="width: 50% ; " value="<?php echo $Zoom_Pass?>" >
                  	</div>
                  	<label for="sgl" class="col-sm-3 control-label">Zoom Passowrd :</label>
