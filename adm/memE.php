...
?>
	...
	<div id="layer3" style="position: absolute; width: 50%; height:100px; z-index: 3; left: 48%; top: 50px">
			...
			<form class="form-horizontal" method="POST" action="memUP.php?id=<?php echo $idg ?> " enctype="multipart/form-data">
		...
		<div class="form-group">
          		  ...
          		  <div class="col-sm-9">
                  	...
                  	<label for="name" class="col-sm-3 control-label">اسم العضو:</label>
