    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="fsol_add.php">
          		  <div class="form-group">
          		  
          		  <div class="col-sm-9">
                    	<input type="text" class="form-control" id="employee" name="name" >
                  	</div>
                  	<label for="name" class="col-sm-3 control-label">الفصول</label>
        ...
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b><span id="employee_name"></span></b></h4>
          		...
          		<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="fsol_edit.php">
            	...
            	<input type="hidden" id="id_edit" name="id">
          		  ...
          		  <h2  id="sgl_edit" class="bold"></h2>
                  	...
                  	<label for="name" class="col-sm-3 control-label">الصف</label>
...
<label for="sf" class="col-sm-3 control-label">الفصل</label> 	
</div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="fsol_delete.php">
